...
#define H_MIN_NUMBER 30 //Limit set to recognize Numberplate for HSV Hue (minimum)
#define H_MAX_NUMBER 55 //Limit set to recognize Numberplate for HSV Hue (maximum)
#define S_MIN_NUMBER 60 //Limit set to recognize Numberplate for HSV Saturation (minimum)
#define S_MAX_NUMBER 100
#define V_MIN_NUMBER 75 //Limit set to recognize Numberplate for HSV Value (minimum)
#define V_MAX_NUMBER 100
...
void MainWindow::loadMasks(int hoogte)
{
...
int MainWindow::compareWithMasks(QImage image)
{
